...
public class UI {
	...
	private void packSplit() {
		...
		splitLeft.add(splitLeftPanel);
		splitLeft.add(splitRight);		
		splitRight.add(splitCenterPanel);
		splitRight.add(splitRightBox);
	}
	...
	private void declareSplit() {
		// TODO Auto-generated method stub
		splitLeft=new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, true);
		splitRight=new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, true);
